...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/home/salvador/env/botiga_final/eggs/setuptools-0.6c12dev_r88846-py2.7.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/home/salvador/env/botiga_final/eggs/setuptools-0.6c12dev_r88846-py2.7.egg',
        '/home/salvador/env/botiga_final/eggs/zc.buildout-1.7.0-py2.7.egg'
        ]
